...
Material ProcessMaterial()
{
	...
	float flowspeed = clamp(length(flowDirection), 0, 1.0);
/*
...
*/
	...
	material.Normal = 1.1 * normalmix; // Slightly overbright so that the bright spots blend together and hide a lot of pixellation
